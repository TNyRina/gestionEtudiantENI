	...
	if (isset($_POST['btn_enregistrer'])) 
	{
		...
		if ($verification==null) {
			...
			try {
				...
				:id_org, :Anne_univ, :note, :president, :examinateur, :rapporteur_int, :rapporteur_ext)");
				$req->execute(array(
				'matricule' => $matricule,
				'id_org' => $org,
				'Anne_univ' => $annee,
			...
			<fieldset>
				...
				<div>
					...
					<select name="annee" size="1">
						<?php 
							$annee=$PDO->query("SELECT * FROM anne");
				...
				<div>
					...
					<select name="president" required>
						<?php 
							selection_nom_prof($select_nom_prof,"nom_prof","prenom_prof");
						 ?>
					</select>
				</div>
				<div>
